...
const LandingEventModal = ({ event, onClose }) => {
    ...
    return (
        <div className="fixed inset-0 z-[999] flex items-center justify-center p-4 bg-black/70 backdrop-blur-md" onClick={onClose}>
            <div className="bg-[#080c0a] border border-[#05acc1]/30 rounded-2xl max-w-lg w-full relative z-10 shadow-[0_0_40px_rgba(5,172,193,0.15)] overflow-hidden" onClick={e => e.stopPropagation()}>
                {event.imageUrl && (
